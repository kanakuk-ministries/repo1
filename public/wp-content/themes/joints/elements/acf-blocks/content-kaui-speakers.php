...
<div class="hero-container <?php echo $fields['size']; ?> mb-0 speaker-section-height">
    ...
    <div class="hero-content-container">
        <div class="grid-x grid-container hero-content-inner-container">
            ...
            <div class="hero-content-background <?php echo $fields['text_overlay_alignment']; ?> custom-hero-content">

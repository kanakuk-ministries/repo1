                                                    ...
                                                    <?php if (isset($kamp['activities']) && reset($kamp['activities'])): ?>
                                                        <ul class="list-grid-container activity-grid all-activity">
                                                            ...
                                                            ?>
                                                                ...
                                                                ?>
                                                                <div class="list-grid-item block-<?php echo $i; ?>"  data-toggle="modal" data-target="#about-all-activities">
...
<!--                                                                            <button class="button expanded white hollow">Watch Video</button> -->
            ...
            <div id="about-all-activities" class="modal fade popout-about-card image-popup">

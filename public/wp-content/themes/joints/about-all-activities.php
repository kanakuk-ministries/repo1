                                            ...
                                            <?php if ($kamp['kamp_type']->post_title === $value['title']) : ?>
                                                <div class="list-grid-section-container">
                                                    ...
                                                    <?php if (isset($kamp['activities']) && reset($kamp['activities'])): ?>
                                                        <ul class="list-grid-container activity-grid all-activity">
                                                            <?php
                                                                $i = 0;
                                                            ...
                                                            ?>
                                                                ...
                                                                ?>
                                                                <div class="list-grid-item block-<?php echo $i; ?>"  data-toggle="modal" data-target="#about-all-activities<?php echo $activity_id[0]?>">
...
<!--                                                                            <button class="button expanded white hollow">Watch Video</button> -->
            ...
            <div id="about-all-activities<?php echo $activity_id[0]?>" class="modal fade popout-about-card image-popup">
    ...
    <!-- <div id="MyPopup" class="modal fade in" role="dialog" aria-hidden="false" style="display: block;">
